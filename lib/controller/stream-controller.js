...
var StreamController = function (_EventHandler) {
  ...
  function StreamController(hls) {
    ...
    var _this = _possibleConstructorReturn(this, _EventHandler.call(this, hls, Event.MEDIA_ATTACHED, Event.MEDIA_DETACHING, Event.MANIFEST_LOADING, Event.MANIFEST_PARSED, Event.LEVEL_LOADED, Event.KEY_LOADED, Event.FRAG_LOADED, Event.FRAG_LOAD_EMERGENCY_ABORTED, Event.FRAG_PARSING_INIT_SEGMENT, Event.FRAG_PARSING_DATA, Event.FRAG_PARSED, Event.ERROR, Event.AUDIO_TRACK_SWITCHING, Event.AUDIO_TRACK_SWITCHED, Event.BUFFER_CREATED, Event.BUFFER_APPENDED, Event.BUFFER_FLUSHED));
    ...
    if (this.state === State.PARSED && (!this.appended || !this.pendingBuffering)) {
      ...
      if (frag) {
        ...
        var bufferedFrags = this._bufferedFrags.filter(function (frag) {
          return BufferHelper.isBuffered(media, (frag.startPTS + frag.endPTS) / 2);
        });
        // push new range
  ...
  _createClass(StreamController, [{
    ...
    set: function set(nextState) {
      if (this.state !== nextState) {
        ...
        this.hls.trigger(Event.STREAM_STATE_TRANSITION, { previousState: previousState, nextState: nextState });
      }
    },
    get: function get() {
      return this._state;
